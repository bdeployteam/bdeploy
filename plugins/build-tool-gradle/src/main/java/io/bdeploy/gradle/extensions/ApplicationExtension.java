...
public class ApplicationExtension {
	...
	/**
	 * @return the path to the 'app-info.yaml'. The 'app-info.yaml' is assumed to be
	 *         placed in the root directory of the binaries for the specified
	 *         application.
	 */
	...
	/**
	 * @return the list of supported operating systems. if not given, the list is
	 *         inferred from the 'app-info.yaml'
	 */
