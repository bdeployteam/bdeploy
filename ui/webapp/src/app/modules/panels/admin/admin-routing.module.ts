...
const routes: Routes = [
  ...
  { path: 'add-ldap-server', component: AddLdapServerComponent, canActivate: [AdminGuard], canDeactivate: [DirtyDialogGuard] },
  ...
  { path: 'global-attribute-add', component: AddGlobalAttributeComponent, canActivate: [AdminGuard], canDeactivate: [DirtyDialogGuard] },
  ...
  { path: 'add-user', component: AddUserComponent, canActivate: [AdminGuard], canDeactivate: [DirtyDialogGuard] },
