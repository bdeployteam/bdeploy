...
const INSTANCES_ROUTES: Route[] = [
  ...
  { path: 'history/:key', component: HistoryEntryComponent, canActivate: [ScopedReadGuard] },
  { path: 'history/:key/view/:base', component: HistoryViewComponent, canActivate: [ScopedReadGuard], data: { max: true } },
