...
} from './color-select-group/color-select-group.component';
...
export class BannerComponent
  implements OnDestroy, AfterViewInit, DirtyableDialog
{
        ...
        confirm.subscribe((r) => {
          if (r) {
            if (s?.banner?.text) {
              ...
              this.colorSelect.trySetSelected(
                s.banner.foregroundColor,
                s.banner.backgroundColor
              );
            } else {
