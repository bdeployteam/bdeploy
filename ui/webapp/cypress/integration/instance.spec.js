describe('Instance Tests', function () {
  ...
  it('Check the instance history', () => {
    ...
    cy.contains('mat-expansion-panel', 'Version 4: Created')
      .should('contain.html', 'master')
      .and('contain.html', 'Parameter')
      .and('contain.html', 'param.sleep');

    cy.contains('Version 4: Created').click();
    cy.contains('Version 3: Created').click();

    cy.contains('mat-expansion-panel', 'Version 2: Created')
      .click()
      .should('contain.html', 'master:')
      .and('contain.html', 'Server Application');
    ...
    cy.get('.mat-dialog-container')
      .should('contain.html', 'master:')
      .and('contain.html', 'Config files')
      .and('contain.html', 'cypress.cfg');
    ...
    // and check them
    cy.contains('mat-expansion-panel', 'Server Application started')
      .click()
      .should('contain.html', 'master')
      .and('contain.html', '4');
    cy.contains('mat-expansion-panel', 'Version 4: Activated').click().should('contain.html', 'admin');
