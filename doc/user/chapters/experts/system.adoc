...
Initially, the *System Software* page contains only the running *BDeploy* system software version, and no *BDeploy Launcher*. Use the btn:[+] button to upload either new *BDeploy* or *BDeploy Launcher* versions from their respective binary distributions (_ZIP_).
