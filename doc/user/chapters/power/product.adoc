...
endpoints: <13>
  http:
    - id: "my-endpoint" <14>
      ...
      port: "{{V:port-param}}" <15>
      secure: false
    - id: "Startup Endpoint"
      type: PROBE_STARTUP <16>
