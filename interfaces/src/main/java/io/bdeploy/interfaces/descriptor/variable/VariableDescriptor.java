...
public class VariableDescriptor {
    ...
    /**
     * A globally unique ID of the variable. This is used to identify the "same"
     * variables on different applications which should be configured globally (see
     * {@link ParameterDescriptor#global}).
     * <p>
     * Also used to ensure ordering of variables is the same in the {@link ApplicationConfiguration} as defined in the
    ...
    @JsonPropertyDescription("The arbitrary name of a group. Parameters with the same groupName are grouped in the UI to help the user in identifying variables that belong together.")
